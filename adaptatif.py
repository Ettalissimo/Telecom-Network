...
simulation_duration = 100  # Total simulation time (seconds)
max_call_duration = 100  # Maximum call duration (seconds)
...
call_probability = 0.5  # Probability of a call being made
...
np.savez("simulation_3_results.npz", call_rejections=np.array(call_rejections_over_time))
